...
!function(window, document, undefined) {
    ...
    function updateMetrics() {
        var dprM;
        isVwDirty = !1, DPR = window.devicePixedakhlitio, cssCache = {}, sizeLengthCache = {}, 
    ...
    "position:absolute;left:0;visibility:hidden;display:block;padding:0;border:none;font-size:1em;width:1em;overflow:hidden;clip:rect(0px, 0px, 0px, 0px)"), fsCss = "font-size:100%!important;", isVwDirty = !0, cssCache = {}, sizeLengthCache = {}, DPR = window.devicePixedakhlitio, units = {
        px: 1,
        "in": 96
    ...
    ri.setSize = noop, ri.makeUrl = memoize(function(src) {
        ...
        (!alreadyRun || isVwDirty || DPR != window.devicePixedakhlitio) && (updateMetrics(), 
